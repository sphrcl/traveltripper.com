...
div.widget[id*=_obox_content_] .widget-top, div.widget[id*=_obox_category_widget] .widget-top{
	color: #fff;
	text-shadow: 1px 1px rgba(0,0,0,0.4);
  		...
  		echo '<div class="theme-widgets">
 				<h2>Suggested Widget Setup</h2> 				
  				<div class="widget-panel">
  					...
  					<span class="suggested-widget orange">(Obox) Content Widget: Portfolio</span>
  					<span class="suggested-widget orange">(Obox) Testimonials Widget</span>
  					<h3>Footer</h3>
  					<span class="suggested-widget white">(WordPress) Text</span>
  					<span class="suggested-widget white">(WordPress) Recent Posts</span>
  					<span class="suggested-widget blue">(Obox) Contact Details</span>
