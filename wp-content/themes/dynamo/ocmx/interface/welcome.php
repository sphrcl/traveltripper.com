<?php function ocmx_check_welcome(){
	global $pagenow;
	if(isset($themeid) && !get_option($themeid."_welcome") && isset($_GET["activated"]) && $pagenow = "themes.php") :
...
function ocmx_admin_tabs( $current = 'step1' ) {
	...
	echo $themename; echo $themename." ".$current_theme->Version; 
	echo '</h2>';
                ...
                <div class="columns-1 grid">
                    <div class="column">
                        <div class="obox-help-buttons">
                            <a href="http://kb.oboxsites.com/wp-content/uploads/2013/04/dynamo_demo_content.zip" class="demo-content"><span>Demo Content</span></a>
                            <a href="http://kb.oboxsites.com/themedoc-category/<?php echo $themeid; ?>-docs/" class="documentation" target="_blank"><span>Documentation</span></a>
                        ...
                        <p class="settings-intro">If you need step-by-step instructions for setting up and using the theme, check out our <a href="http://kb.oboxsites.com/themedoc-category/<?php echo $themeid; ?>-docs" target="_blank"><?php echo $themename; ?> Theme documentation</a>. If know your way around WordPress, you can use our Quick Setup steps below.</p>
                    </div>
                </div>
            </div>         
  <?php switch ( $tab ){
         ...
         ?>
           <div class="section">
                    ...
                    <div class="instructions">
                        ...
                        <p class="instruction-intro">Before we can really get started, you first need to add content to WordPress. There are a number of different content types that you can create with <?php echo $themename; ?>. Be sure to read through the theme documentation for details about using each conten type.</p>
