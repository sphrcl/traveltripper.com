(function( $ ) {
	...
	$('#shortcode-dropdown').live('change', function() {
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.button-code');
			shortcode = '[button <span class="red">url=""</span> target="" color="" style="" arrow=""] [/button]';
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.quote');
			shortcode = '[quote author="" type=""] [/quote]';
		/* -------------------------------------------------- */
		/*	Full Banner
		/* -------------------------------------------------- */

		} else if( $currentShortcode === 'fullbanner' ) {

			scribe_show_option('.fullbanner');
			shortcode = '[fullbanner image="" title="" text=""] [/fullbanner]';
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.video');
			shortcode = '[video youtube="" vimeo=""] [/video]';
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.accordion-content');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.content-tabs');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.pricing-tables');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.video-player');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.audio-player');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.alert-boxes');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.post-carousel');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.projects-carousel');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.team-member');
		...
		/* -------------------------------------------------- */
			...
			scribe_show_option('.fullwidth-map');
	...
	$('#insert-shortcode').live('click', function() {
		...
		/* -------------------------------------------------- */
			...
			var bannerimage  = $('#fullbanner-image').val(),
				bannertitle    = $('#fullbanner-title').val(),
				bannertext = $('#fullbanner-content').val();

			shortcode = '[fullbanner';

			if( bannerimage )
				shortcode += ' image="' + bannerimage + '"';

			if( bannertitle )
				shortcode += ' title="' + bannertitle + '"';

			shortcode += ']' + bannertext + '[/fullbanner]';
		...
		/* -------------------------------------------------- */
			...
			var videoyoutube  = $('#video-youtube').val(),
				videovimeo    = $('#video-vimeo').val(),
				videoembed = $('#video-embed').val();

			shortcode = '[video';

			if( videoyoutube )
				shortcode += ' youtube="' + videoyoutube + '"';

			if( videovimeo )
				shortcode += ' vimeo="' + videovimeo + '"';

			shortcode += ']' + videoembed + '[/video]';
	...
	function scribe_show_option( option ) {
