...
$meta_boxer = array(
	...
	'fields' => array(
		...
		array( 
              "name" => "Name of the City You will Be in",
	          "desc" => "The big tagline over the top. The shorter, the better.",
	          "id" => $prefix."_cityname",
	          "type" => "text",
	          "std" => ""
        ...
        array( 
              "name" => "Venue Address",
	          "desc" => "For visual purposes. The latitude / longitude actually create the map pin",
	          "id" => $prefix."_address",
	          "type" => "text",
	          "std" => ""
              )
        ...
        array( 
              "name" => "Event Date",
	          "desc" => "Place the date/dates of the event here.",
	          "id" => $prefix."_datling",
	          "type" => "text",
	          "std" => ""
              )
...
function mythemer_add_boxer() {
	global $meta_boxer;
	foreach ( array( 'location', 'event' ) as $page )
