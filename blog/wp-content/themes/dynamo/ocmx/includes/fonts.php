...
add_action("init", "ocmx_load_font_options");
...
function ocmx_font_script (){
	...
	endforeach;
	wp_enqueue_style( "slider-css",  get_template_directory_uri()."/scripts/typography-manager/jquery-ui.css");
...
add_action("init", "ocmx_font_stylesheet"); 
?>