					...
					<td colspan="3">
						...
						<?php elseif($metabox["input_type"] == "background") : ?>
							...
							<div class="background-position-selectors">
                                ...
                                <?php /*
                                <fieldset class="obox-background-options">
                                    <h4><?php _e('Attachment', 'ocmx'); ?></h4>
                                    <legend class="screen-reader-text"><span><?php _e('Background Attachment', 'ocmx'); ?></span></legend>
                                    <label>
                                        <input name="<?php echo $meta_attributes_form_item; ?>[attachment]" type="radio" value="scroll" <?php if(isset($meta_attributes["attachment"]) && $meta_attributes["attachment"] == 'scroll') : ?>checked="checked"<?php endif; ?>>
                                        <?php _e('Scroll', 'ocmx'); ?>
                                    </label>
                                    <label>
                                        <input name="<?php echo $meta_attributes_form_item; ?>[attachment]" type="radio" value="fixed" <?php if(isset($meta_attributes["attachment"]) && $meta_attributes["attachment"] == 'fixed') : ?>checked="checked"<?php endif; ?>>
                                        <?php _e('Fixed', 'ocmx'); ?>
                                    </label>
                                </fieldset>
						...
						<?php elseif($metabox["input_type"] == "selfhosted") :
